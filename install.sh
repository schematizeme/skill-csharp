#!/usr/bin/env bash
# install.sh — instala a skill schematize-csharp no projeto atual (Claude Code).
#
...
# Como funciona: copia o corpo da skill para .claude/skills/schematize-csharp/ e instala os
...
# Saída: .claude/skills/schematize-csharp/ e .claude/commands/<slug>-*.md no alvo.
set -euo pipefail

SKILL_NAME="schematize-csharp"
