...
> Parte da skill **schematize-csharp**. Continuação de `testes.md` (numeração **preservada**, §22.4+): padrão de script de teste, seeds/personas, integração com CI, pentest (§22.7–22.8), fluxo de Q.A. plan-first (§22.9) e o Makefile padrão (§23).
