...
> Parte da skill **schematize-csharp**. Implementa a §34.1 (handoff de contexto) e a §28 (archive). Conteúdo específico de ferramenta (Claude Code / VS Code) — o princípio normativo está em `references/entrega.md` (§34.1).
