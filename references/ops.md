...
| Deploy, ambientes, artefato imutável, rollback, preview | `schematize-engineering` -> `operacao.md` §21 |
...
| Archive de cada operação | `schematize-engineering` -> `operacao.md` §28 (`<projeto>_archive/`) |
